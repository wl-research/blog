...
When `"Impossible!"` was changed to `"Totally feasible!"`, the contradiction score went from `0.073%` to `99.5%`, even though sentence `s1` is structured very differently. 
